...
-- Verify: effect3 empty, effect2 mask intact
SELECT `entry`, `name`, `effect1`, `effectMiscValue1`,
       `effect2`, `effectMiscValue2`, `effect3`, `effectMiscValue3`
FROM `spell_template` WHERE `entry` = 52317;
